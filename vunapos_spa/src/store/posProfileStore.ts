  ...
  persist(
    (set, get) => ({
      ...
      fetchPOSProfiles: async (force = false) => {
          console.log("fetchPOSProfiles called", {
    isAuthenticated: get().isAuthenticated,
    force
  });
        const { lastProfilesFetch, isLoadingProfiles } = get();
        ...
        try {
          const response = await fetch("/api/method/vunapos.api.profile.get_pos_profiles_for_user", {
            method: "GET",
...
const profiles: POSProfile[] =
  ...
  lastProfilesFetch: Date.now(),
      ...
      fetchPOSDetails: async (force = false) => {
        ...
        try {
          const response = await fetch("/api/method/vunapos.api.profile.get_bootstrap_data", {
            method: "GET",
            headers: { "Accept": "application/json" },
            credentials: "include",
          });
      ...
      fetchPOSOpeningStatus: async (force = false) => {
        ...
        try {
          const response = await fetch("/api/method/vunapos.api.pos_entry.open_pos", {
            method: "GET",
            headers: { "Accept": "application/json" },
            credentials: "include",
          });
      ...
      fetchUserInfo: async (force = false) => {
        ...
        try {
          const response = await fetch("/api/method/vunapos.api.user.get_current_user_info", {
            method: "GET",
            headers: { "Accept": "application/json" },
            credentials: "include",
          });
