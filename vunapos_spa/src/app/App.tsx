...
function AuthenticatedApp() {
	...
	const defaultOrderType = bootstrap.data?.default_order_type || "Sales Invoice";
	const [selectedOrderType, setSelectedOrderType] = useState<{
		defaultOrderType: OrderType;
		value: OrderType;
	} | null>(null);
	const orderType = selectedOrderType?.defaultOrderType === defaultOrderType
	...
	return (
		<>
			...
			<AppShell
				...
				orderType={orderType}
				onOrderTypeChange={(value) => setSelectedOrderType({ defaultOrderType, value })}
