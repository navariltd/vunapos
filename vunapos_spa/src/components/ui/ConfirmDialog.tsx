...
export function ConfirmDialog({ cancelLabel = "Cancel", children, confirmLabel = "Confirm", confirmDisabled = false, danger = false, description, hideCancel = false, isOpen, loading = false, onCancel, onConfirm, size = "md", title }: ConfirmDialogProps) {
	useEffect(() => {
		if (!isOpen) return;
