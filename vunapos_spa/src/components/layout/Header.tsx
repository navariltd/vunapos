...
export function Header({ cashier, posProfile, warehouse }: HeaderProps) {
	return (
		<header className="sticky top-0 z-40 border-b border-outline-variant bg-surface px-3 py-2 sm:px-5">
			<div className="flex items-center justify-between gap-3">
				<h1 className="shrink-0 text-lg font-semibold text-on-surface">VunaPOS</h1>
