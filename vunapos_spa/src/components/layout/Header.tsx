...
export function Header({ allowOrderTypeChange = true, orderType, onOrderTypeChange }: HeaderProps) {
	useThemeSync();
	const orderTypes: OrderType[] = allowOrderTypeChange ? ["Sales Invoice", "Sales Order"] : [orderType];
